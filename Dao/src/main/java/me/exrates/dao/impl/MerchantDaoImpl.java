...
//    return namedParameterJdbcTemplate.queryForObject(sql, params, new BeanPropertyRowMapper<>(Merchant.class));
    ...
    public Optional<MerchantCurrency> findByMerchantAndCurrency(int merchantId, int currencyId) {
        ...
        try {
            return Optional.of(namedParameterJdbcTemplate.queryForObject(sql, params, getMerchantCurrencyRowMapper()));
        } catch (EmptyResultDataAccessException e) {
    ...
    public List<MerchantCurrency> findAllUnblockedForOperationTypeByCurrencies(List<Integer> currenciesId, OperationType operationType) {
        ...
        try {
            return namedParameterJdbcTemplate.query(sql, Collections.singletonMap("currenciesId", currenciesId),
                    getMerchantCurrencyRowMapper());
        } catch (EmptyResultDataAccessException e) {
            return null;
        }
    }

    private RowMapper<MerchantCurrency> getMerchantCurrencyRowMapper() {
        return (resultSet, i) -> {
