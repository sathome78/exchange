...
public class CurrencyDaoImpl implements CurrencyDao {
    ...
    public Optional<Currency> findByName(String name) {
        final String sql = "SELECT * FROM CURRENCY WHERE name = :name LIMIT 1";
        ...
        try {
            return Optional.ofNullable(jdbcTemplate.queryForObject(sql, params, new BeanPropertyRowMapper<>(Currency.class)));
        } catch (EmptyResultDataAccessException e) {
           logger.info("Failed to find currency by name: " + name, e);
