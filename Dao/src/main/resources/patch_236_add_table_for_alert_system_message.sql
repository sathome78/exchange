...
CHANGE COLUMN `alert_type` `alert_type` ENUM('UPDATE', 'TECHNICAL_WORKS', 'SYSTEM_MESSAGE_TO_USERS') NOT NULL ;

INSERT INTO SERVICE_ALERTS (alert_type) VALUES ('SYSTEM_MESSAGE_TO_USERS');
