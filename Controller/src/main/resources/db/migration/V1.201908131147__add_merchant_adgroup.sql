...
VALUES ((SELECT id from MERCHANT WHERE name = 'Adgroup'), '/client/img/merchants/yandexmoney.png',
        'Yandex.Money(Wallet)', (SELECT id from CURRENCY WHERE name = 'RUB')),
       ((SELECT id from MERCHANT WHERE name = 'Adgroup'), '/client/img/merchants/yandexmoney.png',
