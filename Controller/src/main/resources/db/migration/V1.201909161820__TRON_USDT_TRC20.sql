...
VALUES((select id from CURRENCY where name = 'USDT(TRX)'), (select id from CURRENCY where name = 'TRX'), 'USDT(TRX)/TRX', 170, 0, 'USDT(TRX)/TRX');
...
INSERT IGNORE INTO CURRENCY_PAIR (currency1_id, currency2_id, name, pair_order, hidden, ticker_name)
VALUES((select id from CURRENCY where name = 'USDT(TRX)'), (select id from CURRENCY where name = 'BTT'), 'USDT(TRX)/BTT', 170, 0, 'USDT(TRX)/BTT');
...
VALUES((select id from CURRENCY where name = 'USDT(TRX)'), (select id from CURRENCY where name = 'BTC'), 'BTC/USDT(TRX)', 160, 0, 'BTC', 'BTC/USDT(TRX)');
...
INSERT IGNORE INTO CURRENCY_PAIR (currency1_id, currency2_id, name, pair_order, hidden, market ,ticker_name)
VALUES((select id from CURRENCY where name = 'USDT(TRX)'), (select id from CURRENCY where name = 'ETH'), 'ETH/USDT(TRX)', 160, 0, 'ETH', 'ETH/USDT(TRX)');
