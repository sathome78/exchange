...
VALUES((select id from CURRENCY where name = 'BSV'), (select id from CURRENCY where name = 'USD'), 'BSV/USD', 170, 0, 'BSV/USD');
...
VALUES((select id from CURRENCY where name = 'BSV'), (select id from CURRENCY where name = 'BTC'), 'BSV/BTC', 160, 0, 'BTC', 'BSV/BTC');
...
INSERT IGNORE INTO CURRENCY_PAIR (currency1_id, currency2_id, name, pair_order, hidden, market ,ticker_name)
VALUES((select id from CURRENCY where name = 'BSV'), (select id from CURRENCY where name = 'ETH'), 'BSV/ETH', 160, 0, 'ETH', 'BSV/ETH');
...
VALUES ((SELECT id FROM MERCHANT WHERE name = 'SimpleTransfer'), (select id from CURRENCY where name = 'BSV'), 0.0001, 1, 1, 0);

INSERT IGNORE INTO MERCHANT_CURRENCY (merchant_id, currency_id, min_sum, withdraw_block, refill_block, transfer_block)
VALUES ((SELECT id FROM MERCHANT WHERE name = 'VoucherTransfer'), (select id from CURRENCY where name = 'BSV'), 0.0001, 1, 1, 0);

INSERT IGNORE INTO MERCHANT_CURRENCY (merchant_id, currency_id, min_sum, withdraw_block, refill_block, transfer_block)
VALUES ((SELECT id FROM MERCHANT WHERE name = 'VoucherFreeTransfer'), (select id from CURRENCY where name = 'BSV'), 0.0001, 1, 1, 0);
...
VALUES ((SELECT id from MERCHANT WHERE name='BSV'), (select id from CURRENCY where name='BSV'), 'CRYPWallet.title', 'pass123');
