...
<%--&lt;%&ndash;don't show entrance menu item in header for pages that contain it's own capcha because conflict occurs&ndash;%&gt;--%>
            ...
            <%--<ul class="nav header__nav">--%>
                ...
                <%--<ul class="padding0 pull-right">--%>
                    <%--<sec:authorize access="! isAuthenticated()">--%>
                        ...
                        <%--&lt;%&ndash;<a id="login_link" data-fancybox href="#login" class="demo-bar-item">login</a>&ndash;%&gt;--%>
                    <%--</sec:authorize>--%>
                <%--</ul>--%>
            <%--</ul>--%>
        <%--</div>--%>
    ...
    <%--<div id="registration" class="popup">--%>
        <%--<div class="popup__inner">--%>
            ...
            <%--<form id="create_me" class="form" method="post">--%>
                ...
                <%--&lt;%&ndash;<div class="field__label">Nickname</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<input id="nickname" class="field__input" type="text" name="nickname" placeholder="Nickname" required>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div id="nickname_exists" class='field__error' style="display:none">&ndash;%&gt;--%>
                <%--&lt;%&ndash;Nichname exists&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div id="nichname_wrong" class='field__error' style="display:none">&ndash;%&gt;--%>
                <%--&lt;%&ndash;Wrong nichname&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--<div class="field">--%>
                    <%--<div class="field__label">Email</div>--%>
