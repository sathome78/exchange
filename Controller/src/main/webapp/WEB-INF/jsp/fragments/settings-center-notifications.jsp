            ...
            <%--<div class="col-sm-6 content">--%>
                ...
                <%--<c:if test="${notificationOptions.size() > 0}">--%>
                    ...
                    <%--<table id="notification-options-table" class="table">--%>
                        ...
                        <%--<tr>--%>
                            <%--<th></th>--%>
                            <%--&lt;%&ndash;<th><loc:message code="notification.options.sendNotification"/></th>&ndash;%&gt;--%>
                        ...
                        <%--<c:forEach items="${notificationOptions}" var="notificationOption" varStatus="optStatus">--%>
                            <%--<tr>--%>
                                ...
                                <%--&lt;%&ndash;<td><form:checkbox path="options[${optStatus.index}].sendNotification" value="${notificationOption.sendNotification}"/></td>&ndash;%&gt;--%>
