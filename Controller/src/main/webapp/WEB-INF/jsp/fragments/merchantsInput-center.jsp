            ...
            <%--<div class="input-block-wrapper clearfix">--%>
              ...
              <%--<div style="width: auto; " class="col-md-8 input-block-wrapper__input-wrapper">--%>
                <%--<input id="sum"--%>
                       ...
                       <%--data-max-amount="${balance}" &lt;%&ndash;для USER_TRANSFER другое значение: ищи #maxForTransfer&ndash;%&gt;--%>
                       <%--data-min-amount--%>
              ...
              <%--<div class="col-md-6 input-block-wrapper__label-wrapper">--%>
                <%--<div id="min-sum-notification" class="red"><loc:message code="merchants.input.minSum"/>--%>
                  <%--<strong> <span id="minSum"> &lt;%&ndash;<fmt:formatNumber value="${minRefillSum}"--%>
                                                                    <%--pattern="###,##0.00######"/>&ndash;%&gt;</span>--%>
                      <%--${currency.name}--%>
                  <%--</strong></div>--%>
              <%--</div>--%>
            <%--</div>--%>
                        ...
                        <%--<div>--%>
                          ...
                          <%--<div class="alert alert-success">--%>
                            <%--<loc:message code="refill.messageAboutCurrentAddressSimple"/>--%>
                              <%--<div id="address-to-pay" &lt;%&ndash;style="font-size:16px"&ndash;%&gt;>--%>
                          ...
                          <%--</div>--%>
                              <%--&lt;%&ndash;<loc:message code="merchants.modalOutputAddressTag"/>&ndash;%&gt;--%>
                          <%--<div class="alert alert-success">--%>
