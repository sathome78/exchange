...
<%--<header class="header">--%>
    ...
    <%--&lt;%&ndash; Regitration with referral link | START &ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash; Regitration with referral link | END &ndash;%&gt;--%>

    <%--&lt;%&ndash; Regitration | START &ndash;%&gt;--%>
