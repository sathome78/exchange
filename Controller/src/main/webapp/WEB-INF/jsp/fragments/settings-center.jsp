<div id="settings-page" class="settings">
    <div class="row" style="padding: 10px 0">
        <ul id="user-settings-menu" class="nav nav-pills">
            ...
            <li><a data-toggle="pill" href="#control-phrase-wrapper"><loc:message code="controlPhrase"/></a></li>
        </ul>
    </div>
    ...
    <div class="tab-content">
        ...
        <div id="control-phrase-wrapper" class="tab-pane fade">
            <%@include file="control-phrase-settings.jsp" %>
        </div>
