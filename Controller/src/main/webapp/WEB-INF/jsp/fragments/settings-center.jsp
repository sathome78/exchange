<%--<div id="settings-page" class="settings">--%>
    <%--<div class="row" style="padding: 10px 0">--%>
        <%--<ul id="user-settings-menu" class="nav nav-pills">--%>
            ...
            <%--&lt;%&ndash;<li><a data-toggle="pill" href="#notification-options-wrapper"><loc:message code="notifications.settings"/></a></li>&ndash;%&gt;--%>
    ...
    <%--<div class="tab-content">--%>
        ...
        <%--</div>--%>
        <%--&lt;%&ndash;<div id="notification-options-wrapper" class="tab-pane fade">--%>
