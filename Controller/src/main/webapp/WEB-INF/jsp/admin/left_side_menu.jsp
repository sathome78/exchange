<%--<%@ page import="me.exrates.model.enums.AdminAuthority" %>&lt;%&ndash;--%>
...
<%--<div class="sidebar">--%>
    <%--<ul>--%>
        ...
        <%--<li>--%>
            <%--&lt;%&ndash;auto trading settings&ndash;%&gt;--%>
