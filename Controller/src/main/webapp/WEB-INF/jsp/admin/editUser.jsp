...
<%--<main class="container orders_new admin side_menu">--%>
  <%--<div class="row">--%>
    ...
    <%--<div class="col-md-8 col-md-offset-1 content admin-container">--%>
      <%--<div class="buttons">--%>
        <%--&lt;%&ndash;Редактирование пользователя&ndash;%&gt;--%>
        ...
        <%--<sec:authorize access="<%=AdminController.adminAnyAuthority%>">--%>
          ...
          <%--&lt;%&ndash;Access for operation | START&ndash;%&gt;--%>
          <%--<sec:authorize access="<%=AdminController.adminAnyAuthority%>">--%>
            <%--<button class="adminForm-toggler yellow-box">--%>
              <%--Access--%>
            <%--</button>--%>
          <%--</sec:authorize>--%>
          <%--&lt;%&ndash;Access for operation | END&ndash;%&gt;--%>
        ...
        <%--</sec:authorize>--%>
      <%--</div>--%>
      <%--&lt;%&ndash;Current user and email&ndash;%&gt;--%>
      <%--<div>--%>
        <%--<h5><b>--%>
          <%--<c:choose>--%>
      ...
      <%--&lt;%&ndash;контейнер для данных пользователей&ndash;%&gt;--%>
      <%--<div class="tab-content">--%>
        <%--&lt;%&ndash;форма редактирование пользователя&ndash;%&gt;--%>
          ...
          <%--<div class="col-md-8 content">--%>
            ...
            <%--<div class="panel-body">--%>
                  ...
                  <%--<fieldset class="field-user">--%>
                    ...
                    <%--<sec:authorize access="hasAuthority('${adminEnum}')">--%>
                      ...
                      <%--<div class="input-block-wrapper">--%>
                        ...
                        <%--</div>--%>
                        <%--<div class="col-md-9 input-block-wrapper__input-wrapper">--%>
                          <%--&lt;%&ndash;<form:input path="role" id="user-role"--%>
                                      <%--class="input-block-wrapper__input admin-form-input"--%>
                                      <%--name="user-role" />&ndash;%&gt;--%>
              ...
              <%--<c:choose>--%>
                ...
                <%--</c:when>--%>
              <%--</c:choose>--%>
             <%--&lt;%&ndash; <%@include file="../fragments/admin-settings-user-2fa.jsp" %>&ndash;%&gt;--%>
            <%--</div>--%>
          <%--</div>--%>
        <%--</div>--%>

        <%--&lt;%&ndash;форма список транзакций&ndash;%&gt;--%>
        ...
        <%--&lt;%&ndash;форма список кошельков&ndash;%&gt;--%>
        <%--<div id="panel3" class="tab-pane">--%>
          <%--&lt;%&ndash;<div class="container orders_new transaction my_orders orders .container_footer_bottom my_wallets">&ndash;%&gt;--%>
          <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
          <%--<div class="col-md-10 content">--%>
            <%--&lt;%&ndash;СПИСОК СЧЕТОВ&ndash;%&gt;--%>
          ...
          <%--<div class="col-md-12 content">--%>
            ...
            <%--<table id="ordersSellTable"--%>
              ...
              <%--<tr>--%>
                ...
                <%--&lt;%&ndash;<th class="col-2 myo_delt center blue-white"></th>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<th class="col-4 myo_cnsl right blue-white"><loc:message code="myorders.canceldate"/></th>&ndash;%&gt;--%>
          ...
          <%--<div class="col-md-12 content">--%>
            ...
            <%--<table id="commentsTable"--%>
              ...
              <%--<tr>--%>
                ...
                <%--&lt;%&ndash;MessageSent&ndash;%&gt;--%>
                <%--<th></th>--%>
                <%--&lt;%&ndash;Comment id&ndash;%&gt;--%>
                <%--<th>123</th>--%>
              <%--</tr>--%>
              <%--</thead>--%>
            <%--</table>--%>
