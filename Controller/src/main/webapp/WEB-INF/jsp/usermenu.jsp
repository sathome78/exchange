...
<%--<aside class="sidebar">--%>
    ...
    <%--<div class="sidebar__wrapper">--%>
        ...
        <%--<ul class="navbar">--%>
            ...
            <%--</li>--%>
            <%--<li class="navabr__item">--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="usermenu.settings"/></a>&ndash;%&gt;--%>
        ...
        <%--<!-- begin sub__navbar  -->--%>
        <%--&lt;%&ndash;<ul class="sub__navbar ">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li class="navabr__item">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="subusermenu.commissions"/></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li class="navabr__item">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="subusermenu.news"/></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li class="navabr__item">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="subusermenu.api"/></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li class="navabr__item">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="subusermenu.rules"/></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li class="navabr__item">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="navabr__link"><loc:message code="subusermenu.faq"/></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
        <%--<!-- end sub__navbar  -->--%>
    <%--</div>--%>
