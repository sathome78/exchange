...
(
    ...
    KEY `composite_index_exorder_1` (`status_id`, `operation_type_id`, `currency_pair_id`, `user_id`,
                                     `user_acceptor_id`),
...
(
    ...
    KEY `user_wallet_id_operation_type_id_status_id_provided_datetime` (`user_wallet_id`, `operation_type_id`,
                                                                        `status_id`, `provided`, `datetime`),
