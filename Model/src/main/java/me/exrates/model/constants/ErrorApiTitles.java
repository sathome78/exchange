...
public interface ErrorApiTitles {
    ...
    String USER_EMAIL_NOT_DECODED = "USER_EMAIL_NOT_DECODED";
    ...
    String EMAIL_AUTHORIZATION_FAILED_AND_RESENT = "EMAIL_AUTHORIZATION_FAILED_AND_RESENT";
    ...
    String KYC_VERIFICATION_REQUIRED = "KYC_VERIFICATION_REQUIRED";
    String RESTRICTIONS_COUNTRY_ISSUE = "RESTRICTIONS_COUNTRY_ISSUE";
    ...
    String QUBERA_RESPONSE_GET_BALANCE_ERROR = "QUBERA_RESPONSE_GET_BALANCE_ERROR";
    ...
    String QUBERA_PAYMENT_INTERNAL_ERROR = "QUBERA_PAYMENT_INTERNAL_ERROR";
    ...
    String ENFINS_ERROR_HTTP_CLIENT = "ENFINS_ERROR_HTTP_CLIENT";
    String ENFINS_HTTP_CLIENT_RESPONSE_NOT_200 = "ENFINS_HTTP_CLIENT_RESPONSE_NOT_200";
    String EMAIL_AUTHORIZATION_PIN_EXPIRED = "EMAIL_AUTHORIZATION_PIN_EXPIRED";

    String SETTINGS_ERROR_GET_USER_SESSIONS_HISTORY = "SETTINGS_ERROR_GET_USER_SESSIONS_HISTORY";
}
