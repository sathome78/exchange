...
public enum RefillRequestTableViewTypeEnum {
  ...
  TO_VERIFY(WAITING_VERIFY, ON_VERIFY_BY_ADMIN),
  ACCEPTED(ACCEPTED_ADMIN, ACCEPTED_AUTO, ACCEPTED_AUTO_AFTER_VERIFY),
  DECLINED(DECLINED_ADMIN,DECLINED_AFTER_VERIFY);
