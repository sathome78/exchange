...
public enum WithdrawRequestTableViewTypeEnum {
    ...
    ALL,
    TO_VERIFY(WAITING_ANALYTICS_CONFIRMATION_FOR_MANUAL, WAITING_ANALYTICS_CONFIRMATION_FOR_SEMI_AUTO, IN_WORK_OF_ANALYTICS_FOR_MANUAL, IN_WORK_OF_ANALYTICS_SEMI_AUTO),
    ...
    DECLINED(DECLINED_ADMIN, DECLINED_ERROR, DECLINED_ANALYTICS_MANUAL, DECLINED_ANALYTICS_SEMI_AUTO, REVOKED_USER),
