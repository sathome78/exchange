...
//            String price = pair.getKey().multiply(new BigDecimal(coinsCount)).toString();
            String transactionId = sendTransactionHit(userName, coinsCount, "", tiker);
            log.info("Successfully send transaction hit to gtag");
            sendItemHit(userName, transactionId, tiker, coinsCount, "");
    ...
    public String sendTransactionHit(String userName, String coinsCount, String price, String tiker) {
    ...
    public void sendItemHit(String userName, String transactionId, String tiker, String amount, String price) {
