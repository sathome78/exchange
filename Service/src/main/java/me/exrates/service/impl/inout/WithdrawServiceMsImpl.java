...
public class WithdrawServiceMsImpl extends WithdrawServiceImpl {
    ...
    private static final String API_WITHDRAW_CHECK_OUTPUT_REQUESTS_LIMIT = "/api/withdraw/checkOutputRequestsLimit";
    private static final String API_WITHDRAW_GET_ADDITIONAL_SERVICE_DATA = "/api/withdraw/getAdditionalServiceData/";
    ...
    public WithdrawServiceMsImpl(ObjectMapper objectMapper, InOutProperties properties, RequestUtil requestUtil, UserService userService) {
    ...
    public void setAdditionalData(MerchantCurrency merchantCurrency, User user) {
        RestTemplate restTemplate = new RestTemplate();
        WithdrawableDataDto dto = restTemplate.getForObject(properties.getUrl() + API_WITHDRAW_GET_ADDITIONAL_SERVICE_DATA + merchantCurrency.getMerchantId(), WithdrawableDataDto.class);
