...
import me.exrates.service.impl.InterkassaServiceImpl;
...
public class InterkassaServiceMsImpl extends InterkassaServiceImpl {

    private final RabbitService rabbitMqService;
    private int merchantId;

    public InterkassaServiceMsImpl(RabbitService rabbitService, MerchantService merchantService) {
