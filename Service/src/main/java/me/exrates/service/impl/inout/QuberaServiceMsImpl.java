...
import me.exrates.service.QuberaServiceImpl;
...
public class QuberaServiceMsImpl extends QuberaServiceImpl {

    private final RabbitService rabbitMqService;
    private int merchantId;

    public QuberaServiceMsImpl(RabbitService rabbitService, MerchantService merchantService) {
