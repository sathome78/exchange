...
public class NAC extends Contract implements ethTokenERC20 {
    ...
    public RemoteCall<TransactionReceipt> setPresalePhase(BigInteger _nextPhase) {
        final Function function = new Function(
                "setPresalePhase", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint8(_nextPhase)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setCrowdsaleManager(String _mgr) {
        final Function function = new Function(
                "setCrowdsaleManager", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_mgr)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> safeWithdraw(String _withdraw, BigInteger _amount) {
        final Function function = new Function(
                "safeWithdraw", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_withdraw), 
    ...
    public RemoteCall<TransactionReceipt> changeBinary(BigInteger _binary) {
        final Function function = new Function(
                "changeBinary", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_binary)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> changeEscrow(String _escrow) {
        final Function function = new Function(
                "changeEscrow", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_escrow)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> changeBinaryAddress(String _binaryAddress) {
        final Function function = new Function(
                "changeBinaryAddress", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_binaryAddress)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<NAC> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String _escrow, String _namiMultiSigWallet, String _namiPresale) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_escrow), 
                new org.web3j.abi.datatypes.Address(_namiMultiSigWallet), 
                new org.web3j.abi.datatypes.Address(_namiPresale)));
