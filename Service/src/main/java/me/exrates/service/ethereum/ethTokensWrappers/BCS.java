...
public class BCS extends Contract implements ethTokenERC20 {
    ...
    public RemoteCall<TransactionReceipt> setValueAgent(String newAgent) {
        final Function function = new Function(
                "setValueAgent", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(newAgent)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setLockedState(Boolean state) {
        final Function function = new Function(
                "setLockedState", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Bool(state)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> lockTransferFor(String holder, BigInteger daysFromNow) {
        final Function function = new Function(
                "lockTransferFor", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(holder), 
                new org.web3j.abi.datatypes.generated.Uint256(daysFromNow)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
