...
public class PLTC extends Contract implements ethTokenERC20 {
    ...
    public RemoteCall<TransactionReceipt> initWallets(String _teamWallet, String _advisorWallet, String _bountyWallet, String _earlyInvWallet) {
        final Function function = new Function(
                FUNC_INITWALLETS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_teamWallet), 
                new org.web3j.abi.datatypes.Address(_advisorWallet), 
                new org.web3j.abi.datatypes.Address(_bountyWallet), 
                new org.web3j.abi.datatypes.Address(_earlyInvWallet)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
