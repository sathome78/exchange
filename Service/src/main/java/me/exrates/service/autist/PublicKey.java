...
public class PublicKey implements ByteTransformable {
    ...
    public byte[] toByteArray() throws SteemInvalidTransactionException {
        return this.getPublicKey().isCompressed() ? this.getPublicKey().getPubKey() : org.bitcoinj.core.ECKey.fromPublicOnly(org.bitcoinj.core.ECKey.compressPoint(this.getPublicKey().getPubKeyPoint())).getPubKey();
    }
