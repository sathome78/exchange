...
public interface InputOutputService {
  ...
  List<MyInputOutputHistoryDto> getMyInputOutputHistory(String email, Integer offset, Integer limit, String dateFrom, String dateTo, String currency, Locale locale);
