...
public class ServiceTestConfig {
    ...
    public StompMessenger stompMessenger() {
        return new StompMessengerImpl(defaultSimpUserRegistry(), objectMapper(),
                orderService(), redisUserNotificationService(), redisWsSessionService(), simpMessagingTemplate(), userService());
    }
    ...
    @Bean
    public RedisWsSessionService redisWsSessionService() {
        return Mockito.mock(RedisWsSessionService.class);
    }
