...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
            ...
            .antMatchers(POST, "/createPasswordConfirm", "/afgssr/call/refill", "/afgssr/gtag").permitAll()
    ...
    http.logout()
            ...
            .ignoringAntMatchers("/chat-en/**", "/chat-ru/**", "/chat-cn/**",  "/chat-ar/**", "/chat-in/**", "/chat-ko/**",
                    ...
                    "/test/**",
                    "/rest/user/register", "/rest/user/authenticate", "/rest/user/restorePassword", "/afgssr/call/refill","/afgssr/gtag");
    http
            .headers()
            .frameOptions()
            .sameOrigin();
