...
public class WebSocketAuthenticatorServiceImpl implements WebSocketAuthenticatorService {
    private static final Logger logger = LogManager.getLogger(WebSocketAuthenticatorServiceImpl.class);
    ...
    @Autowired
    public WebSocketAuthenticatorServiceImpl(AuthTokenService authTokenService, UserDetailsService userDetailsService, OpenApiAuthService openApiAuthService) {
